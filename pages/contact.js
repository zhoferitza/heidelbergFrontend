        ...
        <div className='relative mx-auto max-w-xl'>
          ...
          <div className='text-center'>
            ...
            <p className='mt-4 text-lg leading-6 text-gray-500'>
              Please DO NOT send an Order or Adjustments to Orders via this
              Form. We do not accept Online Orders at this time. If you send a
              Order or an Adjustment via this Form it will not get filled. We
              look forward to hearing from you for General Comments and
              Questions.
            </p>
          </div>
          <div className='mt-12'>
